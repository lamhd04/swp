                        ...
                        <c:forEach items="${listE}" var="o">
                            <div class="single_blog">
                                ...
                                <div class="post_content_wrapper">
                                    <div class="post_date"><p>Posted On : ${o.date} - <span>Category: ${o.exam_cate}</span></p></div>
                                    <h3><a href="examdetail?examID=${o.examID}" title="">${o.title}</a></h3>
                                    <p>${o.brief}</p>
                        ...
                        <div class="pagination_blog">
                            <ul>
                                <c:forEach begin="1" end="${endP}" var="i">
                                    <li class="current"><a href="exam?index=${i}">${i}</a></li>  
                                    </c:forEach>
                            </ul>
                        </div>            
                    </div> 
                                ...
                                <c:forEach items="${listEC}" var="o">
                                    <div class="archives-items">
                                        <ul class="list-unstyled">
                                            <li><a href="examcategory?exam_cate=${o.settingId}" title="">${o.settingValue}</a></li>
                                        </ul>
                                    </div>
                                </c:forEach>
                            </div>                            
