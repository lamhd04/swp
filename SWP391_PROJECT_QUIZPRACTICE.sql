...
insert into Setting values (7,'quiz_category','Science',1,'active')
insert into Setting values (8,'quiz_category','Math',2,'active')
insert into Setting values (9,'quiz_category','Biology',3,'active')
insert into Setting values (10,'quiz_category','Human Atanomy',4,'active')
insert into Setting values (11,'Science','Quantum Physics',1,'active')
insert into Setting values (12,'Science','Computer Science',2,'active')
insert into Setting values (13,'Math','Algorithm',1,'active')
insert into Setting values (14,'Math','Discrete Math',2,'active')
insert into Setting values (15,'Biology','Human Disease',1,'active')
insert into Setting values (16,'Biology','Plague',2,'active')
insert into Setting values (17,'Human Atanomy','Skeleton',1,'active')
insert into Setting values (18,'Human Atanomy','Muscle',2,'active')
...
insert into Setting values ('test_type','Free Test',1,'active')
insert into Setting values ('test_type','Quiz Practice',2,'active')
insert into Setting values ('test_type','Simulation Test',3,'active')
