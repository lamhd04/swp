...
public class SubjectOverViewlServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Dimension> listDimensions = new DimensionDAO().getAllBySubjectId(subjectId);
            List<PricePackage> listPackages = new PricePackageDAO().getAllBySubjectId(subjectId);

            request.setAttribute("subject", subject);
            request.setAttribute("listDimensions", listDimensions);
