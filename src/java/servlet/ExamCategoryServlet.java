...
public class ExamCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String exam_cate = request.getParameter("exam_cate");
        List<Exam> list = exd.getPostbyCID(exam_cate);
        List<Setting> listEC = exd.getExamCategories();
        List<Exam> listRecent = exd.getRecentExam();
